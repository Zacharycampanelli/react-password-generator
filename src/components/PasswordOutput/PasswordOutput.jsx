  ...
  return (
    <div className="relative md:w-8/12 lg:w-5/12">
      <input
        ...
        readOnly
      />
      <button className="absolute right-10 top-10 md:top-16 md:right-8 backgroundColor:white fill-white" onClick={() => navigator.clipboard.writeText(passwordContext.state.password)}>
        <CopyIcon />
      </button>
    </div>
  );
